    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <li class="nav-item"><a class="nav-link" href="customer.php"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="CustomerProfile.php"><i class="fas fa-user"></i><span>Profile</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:view_details()"><i class="fas fa-table"></i><span>View Details</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:quality()"><i class="far fa-user-circle"></i><span>Apply for Qualtiy Check</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:cart()"><i class="fas fa-user-circle"></i><span>Delivery Information</span></a></li>
                </ul>
