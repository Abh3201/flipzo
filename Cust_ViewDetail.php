    ...
    <div class="features-boxed">
        <div class="container">
            <div class="intro">
                ...
                <p class="text-center">All types of Products you can get here.</p>
            </div>
            <div class="row justify-content-center features">
			
<?php 
include('connection.php'); 
$displayquery = "select * from cropdetails";
$querydisplay = mysqli_query($link, $displayquery);
while($result = mysqli_fetch_array($querydisplay)){
?>
					<div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i><img src="<?php echo $result['CropImage'];?>" height = '150px' width= '150px'></i><br>
                        <h3 class="name"><?php echo $result['CropName']?>-- <?php echo $result['State'].'('.$result['City'].')'?></h3>
                        <p class="description"><h6>Price --₹<?php echo $result['cost']?>per Kg</h6>Crop Weight:<?php echo $result['CropWeight']?>Kg
						<h6><?php 
						if($result['stock'] == '1')
						{$image = $result['CropImage'];$aadhar=$result['aadhar'];$address=$result['Address'];
							echo 'In Stock'; ?><br><a class="btn btn-light action-button" style="background-color:#e7e7e7; color: black;"role="button" onClick= "function3('<?php echo $image;?>','<?php echo $aadhar;?>','<?php echo $address;?>','<?php echo $result['cost'];?>','<?php echo $result['CropName'];?>')"href="#">Click to Buy</a><?php } 
						else{echo 'Not In stock';}?></h6>
