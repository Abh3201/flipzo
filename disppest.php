...
<body>
    ...
    <div class="features-boxed">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">Pesticides</h2>
                <p class="text-center">All basic Pesticides related to crops can be bought over here</p>
            </div>
            <div class="row justify-content-center features">
			
<?php 
include('connection.php'); 
$displayquery = "select * from pesticides";
$querydisplay = mysqli_query($link, $displayquery);
while($result = mysqli_fetch_array($querydisplay)){
?>
					<div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i><img src="<?php echo $result['image'];?>" height = '150px' width: '150px'></i>
                        <h3 class="name"><?php echo $result['Pest_name']?>-- <?php echo $result['Quantity']?></h3>
                        <p class="description"><h6>Price --₹<?php echo $result['Price']?></h6></p><a class="learn-more" href="#">See More Details »</a></div>
                </div>
				<?php	
}
?>
