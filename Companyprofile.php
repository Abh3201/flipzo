...
<html>
    <script>
        ...
        function myFunction3(){
            sessionStorage.setItem("login1", "ok");
            window.location.replace('FarmClient.php');
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" href="company.php"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:myFunction3()"><i class="fas fa-male"></i><span>Check Customers</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:myFunction2()"><i class="fas fa-male"></i><span>Buy Pest</span></a></li>
                    ...
                    <li class="nav-item"><a class="nav-link active" href="Companyprofile.html"><i class="fas fa-user"></i><span>Profile</span></a></li>
                </ul>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assetsComp/img/avatars/user.jpg" width="160" height="160">
